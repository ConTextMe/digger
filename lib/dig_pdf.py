...
def struct_annotate(args, sentenceStruct, currDatetime, docFilename):
  ...
  for page in sentenceStruct:
    lib.okularAnnotations.AnnotationPageBegin(AnnotationsFileWriter,int(page))
    ...
    for sentence in sentenceStruct[page]:
      if "p" in sentenceStruct[page][sentence]:
        for word in sentenceStruct[page][sentence]["p"]:
          lib.okularAnnotations.AnnotationQuad(AnnotationsFileWriter,sentenceStruct[page]["size"],sentenceStruct[page][sentence]["p"][word])
